...
- **Homing Missile (Salman's Feature):** Advanced heat-seeking missile that automatically locks onto and tracks the nearest enemy vessel. Deals 90 damage.
- **Torpedo (Salman's Feature):** Underwater homing projectile that tracks the nearest enemy ship. Features a unique visual design and wake. Deals 80 damage.

### ✨ Special Abilities (Salman's Features)
...
- **Spacebar**: Toggle Double Speed Boost (Salman's Feature).
- **Left / Right Arrows**: Independent Turret Rotation.
- **1 / 2 / 3 / 4**: Switch Weapons (1=MG, 2=RPG, 3=Missile, 4=Torpedo).
- **C**: Toggle Cheat Mode Auto-Aim & Fire (Salman's Feature).
